 ...
 *
 */
public class YTSequenceActionRequestTest {

  @Test
  public void testSerializeDeserialize() {
    YTSequence.CreateParams params = new YTSequence.CreateParams().setLimitValue(123L);
    OSequenceAction action =
        new OSequenceAction(
            OSequenceAction.CREATE, "testName", params, YTSequence.SEQUENCE_TYPE.ORDERED);
