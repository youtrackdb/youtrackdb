 ...
 */
public class YTDistributedConfigurationChangedException extends YTNeedRetryException
    implements YTHighLevelException {

  public YTDistributedConfigurationChangedException(
      YTDistributedConfigurationChangedException exception) {
    super(exception);
  }

  public YTDistributedConfigurationChangedException(String s) {
    super(s);
  }
}
