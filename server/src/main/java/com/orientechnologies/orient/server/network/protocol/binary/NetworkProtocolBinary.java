...
public class NetworkProtocolBinary extends NetworkProtocol {
  ...
  public NetworkProtocolBinary(OServer server, final String iThreadName) {
   ...
   */
  public void initVariables(final OServer server, SocketChannelBinary channel) {
    this.server = server;
  ...
  public static void writeIdentifiable(
      SocketChannelBinary channel, OClientConnection connection, final Identifiable o)
      throws IOException {
    if (o == null) {
  ...
  private static void writeRecord(
      SocketChannelBinary channel, OClientConnection connection, final RecordAbstract iRecord)
      throws IOException {
