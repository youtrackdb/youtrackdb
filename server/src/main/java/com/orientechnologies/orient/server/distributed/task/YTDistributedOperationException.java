 ...
 */
public class YTDistributedOperationException extends YTNeedRetryException
    implements YTHighLevelException {

  private static final long serialVersionUID = 1L;

  public YTDistributedOperationException(final YTDistributedOperationException exception) {
    super(exception);
  }

  public YTDistributedOperationException(final String message) {
    super(message);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    final String message = ((YTDistributedOperationException) obj).getMessage();
