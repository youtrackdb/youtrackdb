 ...
 *
 */
public class HttpMultipartContentInputStream extends InputStream {

  protected String boundary;

  protected HttpMultipartBaseInputStream wrappedInputStream;

  protected int nextByte;

  protected boolean internalAvailable = true;

  public HttpMultipartContentInputStream(HttpMultipartBaseInputStream in, String iBoundary)
      throws IOException {
