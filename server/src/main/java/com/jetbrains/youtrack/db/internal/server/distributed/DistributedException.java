 ...
 */
public class DistributedException extends SystemException {

  private static final long serialVersionUID = 1L;

  public DistributedException(final DistributedException exception) {
    super(exception);
  }

  public DistributedException(final String message) {
    super(message);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    final String message = ((DistributedException) obj).getMessage();
