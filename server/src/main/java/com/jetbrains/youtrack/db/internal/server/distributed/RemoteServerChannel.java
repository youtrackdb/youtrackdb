 ...
 */
public class RemoteServerChannel {
  ...
  private DistributedRequest prevRequest;
  private DistributedResponse prevResponse;
  ...
  public RemoteServerChannel(
    ...
    executor = ThreadPoolExecutors.newSingleThreadPool("RemoteServerChannel", 10, reject);
  ...
  public void sendRequest(final DistributedRequest request) {
