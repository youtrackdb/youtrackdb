...
public class BetweenConversionTest extends DocumentDBBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      YTDocument document = new YTDocument("BetweenConversionTest");
      document.field("a", i);
      document.field("ai", i);
  ...
  public void testBetweenRightLeftIncluded() {
    ...
    final List<YTDocument> result = database.query(new OSQLSynchQuery<YTDocument>(query));
