 ...
 */
@Test
public class SBTreeRidBagTest extends ORidBagTest {

  private int topThreshold;
  private int bottomThreshold;

  @Parameters(value = "remote")
  public SBTreeRidBagTest(@Optional Boolean remote) {
  ...
  public void testRidBagClusterDistribution() {
    if (database.getStorage().getType().equals(EngineRemote.NAME)
        || database.getStorage().getType().equals(EngineMemory.NAME)) {
      return;
    }
    ...
    final long fileId =
        wowCache.fileIdByName(
            SBTreeCollectionManagerShared.FILE_NAME_PREFIX
                + clusterIdOne
