...
public class SQLFunctionsTest extends DocumentDBBaseTest {
  ...
  public void queryCountExtendsRestricted() {
    ...
    YTDocument docAdmin = new YTDocument("QueryCountExtendsRestrictedClass");
    docAdmin.field(
        "_allowRead",
    ...
    database.begin();
    YTDocument docReader = new YTDocument("QueryCountExtendsRestrictedClass");
  ...
  public void queryCountWithConditions() {
    ...
    database.begin();
    database.<YTDocument>newInstance("Indexed").field("key", "one").save();
    database.<YTDocument>newInstance("Indexed").field("key", "two").save();
    database.commit();
  ...
  public void testFirstFunction() throws UnsupportedEncodingException, NoSuchAlgorithmException {
    ...
    database.begin();
    new YTDocument("V").field("sequence", sequence).save();
    sequence.remove(0);
    new YTDocument("V").field("sequence", sequence).save();
    database.commit();
  ...
  public void testLastFunction() throws UnsupportedEncodingException, NoSuchAlgorithmException {
    ...
    database.begin();
    new YTDocument("V").field("sequence2", sequence).save();
