...
public class LuceneSpatialMiscFunctionsTest extends BaseSpatialLuceneTest {
  ...
  private List<List<Double>> buildArrays1() {
    ...
    list.get(list.size() - 1).add(150D);
    list.get(list.size() - 1).add(90D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(149.0392640201615D);
    list.get(list.size() - 1).add(80.24548389919359D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(146.19397662556435D);
    list.get(list.size() - 1).add(70.86582838174552D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(141.57348061512727D);
    list.get(list.size() - 1).add(62.22148834901989D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(135.35533905932738D);
    list.get(list.size() - 1).add(54.64466094067263D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(127.77851165098011D);
    list.get(list.size() - 1).add(48.42651938487274D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(119.1341716182545D);
    list.get(list.size() - 1).add(43.80602337443566D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(109.75451610080641D);
    list.get(list.size() - 1).add(40.960735979838475D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(100D);
    list.get(list.size() - 1).add(40D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(90.24548389919359D);
    list.get(list.size() - 1).add(40.960735979838475D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(80.86582838174552D);
    list.get(list.size() - 1).add(43.80602337443566D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(72.2214883490199D);
    list.get(list.size() - 1).add(48.426519384872734D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(64.64466094067262D);
    list.get(list.size() - 1).add(54.64466094067262D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(58.426519384872734D);
    list.get(list.size() - 1).add(62.22148834901989D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(53.80602337443566D);
    list.get(list.size() - 1).add(70.86582838174553D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(50.960735979838475D);
    list.get(list.size() - 1).add(80.24548389919362D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(50D);
    list.get(list.size() - 1).add(90.00000000000004D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(50.96073597983849D);
    list.get(list.size() - 1).add(99.75451610080646D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(53.80602337443568D);
    list.get(list.size() - 1).add(109.13417161825454D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(58.426519384872776D);
    list.get(list.size() - 1).add(117.77851165098016D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(64.64466094067268D);
    list.get(list.size() - 1).add(125.35533905932743D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(72.22148834901996D);
    list.get(list.size() - 1).add(131.57348061512732D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(80.8658283817456D);
    list.get(list.size() - 1).add(136.19397662556437D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(90.2454838991937D);
    list.get(list.size() - 1).add(139.03926402016154D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(100.00000000000013D);
    list.get(list.size() - 1).add(140D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(109.75451610080654D);
    list.get(list.size() - 1).add(139.0392640201615D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(119.13417161825463D);
    list.get(list.size() - 1).add(136.1939766255643D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(127.77851165098025D);
    list.get(list.size() - 1).add(131.57348061512718D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(135.3553390593275D);
    list.get(list.size() - 1).add(125.35533905932726D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(141.57348061512735D);
    list.get(list.size() - 1).add(117.77851165097996D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(146.1939766255644D);
    list.get(list.size() - 1).add(109.13417161825431D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(149.03926402016157D);
    list.get(list.size() - 1).add(99.75451610080621D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(150D);
    list.get(list.size() - 1).add(90D);
  ...
  private List<List<Double>> buildArrays2() {
    ...
    list.add(new ArrayList());
    list.get(list.size() - 1).add(64.64466094067262D);
    list.get(list.size() - 1).add(125.35533905932738D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(99.99999999999999D);
    list.get(list.size() - 1).add(140D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(135.35533905932738D);
    list.get(list.size() - 1).add(125.35533905932738D);
  ...
  private List<List<Double>> buildArrays3() {
    ...
    list.add(new ArrayList());
    list.get(list.size() - 1).add(67.92893218813452D);
    list.get(list.size() - 1).add(82.07106781186548D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(69.44429766980397D);
    list.get(list.size() - 1).add(83.31469612302546D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(71.1731656763491D);
    list.get(list.size() - 1).add(84.23879532511287D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(73.04909677983872D);
    list.get(list.size() - 1).add(84.80785280403231D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(75D);
    list.get(list.size() - 1).add(85D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(76.95090322016128D);
    list.get(list.size() - 1).add(84.80785280403231D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(78.8268343236509D);
    list.get(list.size() - 1).add(84.23879532511287D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(80.55570233019603D);
    list.get(list.size() - 1).add(83.31469612302546D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(82.07106781186548D);
    list.get(list.size() - 1).add(82.07106781186548D);
    ...
    list.add(new ArrayList());
    list.get(list.size() - 1).add(85D);
    list.get(list.size() - 1).add(0D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(84.80785280403231D);
    list.get(list.size() - 1).add(-1.9509032201612824D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(84.23879532511287D);
    list.get(list.size() - 1).add(-3.826834323650898D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(83.31469612302546D);
    list.get(list.size() - 1).add(-5.555702330196022D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(82.07106781186548D);
    list.get(list.size() - 1).add(-7.071067811865475D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(80.55570233019603D);
    list.get(list.size() - 1).add(-8.314696123025453D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(78.8268343236509D);
    list.get(list.size() - 1).add(-9.238795325112868D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(76.95090322016128D);
    list.get(list.size() - 1).add(-9.807852804032304D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(75D);
    list.get(list.size() - 1).add(-10D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(73.04909677983872D);
    list.get(list.size() - 1).add(-9.807852804032304D);
    list.add(new ArrayList());
    ...
    list.add(new ArrayList());
    list.get(list.size() - 1).add(67.92893218813452D);
    list.get(list.size() - 1).add(-7.0710678118654755D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(66.68530387697454D);
    list.get(list.size() - 1).add(-5.555702330196022D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(65.76120467488713D);
    list.get(list.size() - 1).add(-3.8268343236508944D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(65.19214719596769D);
    list.get(list.size() - 1).add(-1.9509032201612773D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(65D);
    list.get(list.size() - 1).add(0D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(65D);
    list.get(list.size() - 1).add(50.85786437626905D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(7.071067811865475D);
    list.get(list.size() - 1).add(-7.071067811865475D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(5.555702330196023D);
    list.get(list.size() - 1).add(-8.314696123025453D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(3.8268343236508984D);
    list.get(list.size() - 1).add(-9.238795325112868D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(1.9509032201612833D);
    list.get(list.size() - 1).add(-9.807852804032304D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(0.0000000000000006D);
    list.get(list.size() - 1).add(-10D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-1.950903220161282D);
    list.get(list.size() - 1).add(-9.807852804032304D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-3.826834323650897D);
    list.get(list.size() - 1).add(-9.238795325112868D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-5.55570233019602D);
    list.get(list.size() - 1).add(-8.314696123025453D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-7.071067811865475D);
    list.get(list.size() - 1).add(-7.0710678118654755D);
    ...
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-9.238795325112868D);
    list.get(list.size() - 1).add(-3.826834323650899D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-9.807852804032304D);
    list.get(list.size() - 1).add(-1.9509032201612861D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-10D);
    list.get(list.size() - 1).add(-0.0000000000000012D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-9.807852804032304D);
    list.get(list.size() - 1).add(1.9509032201612837D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-9.238795325112866D);
    list.get(list.size() - 1).add(3.8268343236509006D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-8.314696123025449D);
    list.get(list.size() - 1).add(5.555702330196026D);
    list.add(new ArrayList());
    list.get(list.size() - 1).add(-7.071067811865475D);
    list.get(list.size() - 1).add(7.071067811865475D);
    list.add(new ArrayList());
  ...
  public void testDistance() {
    ...
    assertThat(next.<Double>getProperty("ST_Distance")).isEqualTo(0.44204072210600415);
  }
  ...
  public void testDisjoint() {
    ...
    Assert.assertEquals(next.getProperty("ST_Disjoint"), false);
  }
