...
public class OCommandExecutorSQLUpdateTest extends DBTestBase {
  ...
  public void testIncrementWithDotNotationField() throws Exception {
    ...
    db.begin();
    final YTEntityImpl test = new YTEntityImpl("test");
    test.field("id", "id1");
    test.field("count", 20);
  ...
  public void testUpdateContentNotORestricted() throws Exception {
    ...
    db.begin();
    YTEntityImpl d = new YTEntityImpl("Foo");
    d.field("name", "foo");
    d.save();
  ...
  public void testLinkedUpdate() {
    ...
    db.begin();
    YTEntityImpl state = new YTEntityImpl("TestLinked");
    state.setProperty("id", "idvalue");
    db.save(state);
    db.commit();

    db.begin();
    YTEntityImpl d = new YTEntityImpl("TestSource");
