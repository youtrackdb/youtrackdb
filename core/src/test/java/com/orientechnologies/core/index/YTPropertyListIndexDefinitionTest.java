...
import com.orientechnologies.core.index.OPropertyListIndexDefinition;
 ...
 * @since 20.12.11
 */
public class YTPropertyListIndexDefinitionTest extends DBTestBase {

  private OPropertyListIndexDefinition propertyIndex;

  @Before
  public void beforeMethod() {
    propertyIndex = new OPropertyListIndexDefinition("testClass", "fOne", YTType.INTEGER);
  }
