...
import com.orientechnologies.core.index.OPropertyRidBagIndexDefinition;
 ...
 * @since 1/30/14
 */
public abstract class YTPropertyRidBagAbstractIndexDefinition extends DBTestBase {
  ...
  public void testCreateValueSingleParameter() {
    ...
    Assert.assertTrue(collectionResult.contains(new YTRecordId("#1:12")));
    Assert.assertTrue(collectionResult.contains(new YTRecordId("#1:23")));
  ...
  public void testProcessChangeEventAddOnce() {
    ...
    final OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable> multiValueChangeEvent =
        new OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable>(
            OMultiValueChangeEvent.OChangeType.ADD, new YTRecordId("#1:12"),
            new YTRecordId("#1:12"));
    propertyIndex.processChangeEvent(db, multiValueChangeEvent, keysToAdd, keysToRemove);

    final Map<Object, Integer> addedKeys = new HashMap<Object, Integer>();
    addedKeys.put(new YTRecordId("#1:12"), 1);
  ...
  public void testProcessChangeEventAddTwoTimes() {
    ...
    final OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable> multiValueChangeEventOne =
        new OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable>(
            OMultiValueChangeEvent.OChangeType.ADD, new YTRecordId("#1:12"),
            new YTRecordId("#1:12"));
    final OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable> multiValueChangeEventTwo =
        new OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable>(
            OMultiValueChangeEvent.OChangeType.ADD, new YTRecordId("#1:12"),
            new YTRecordId("#1:12"));
    ...
    final Map<Object, Integer> addedKeys = new HashMap<Object, Integer>();
    addedKeys.put(new YTRecordId("#1:12"), 2);
  ...
  public void testProcessChangeEventAddTwoValues() {
    ...
    final OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable> multiValueChangeEventTwo =
        new OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable>(
            OMultiValueChangeEvent.OChangeType.ADD, new YTRecordId("#1:13"),
            new YTRecordId("#1:13"));
    ...
    final Map<Object, Integer> addedKeys = new HashMap<Object, Integer>();
    addedKeys.put(new YTRecordId("#1:12"), 1);
    addedKeys.put(new YTRecordId("#1:13"), 1);
  ...
  public void testProcessChangeEventRemoveOnce() {
    ...
    final Map<Object, Integer> removedKeys = new HashMap<Object, Integer>();
    removedKeys.put(new YTRecordId("#1:12"), 1);
  ...
  public void testProcessChangeEventRemoveTwoTimes() {
    ...
    final Map<Object, Integer> removedKeys = new HashMap<Object, Integer>();
    removedKeys.put(new YTRecordId("#1:12"), 2);
  ...
  public void testProcessChangeEventAddRemoveInvValue() {
    ...
    addedKeys.put(new YTRecordId("#1:12"), 1);
    final Map<Object, Integer> removedKeys = new HashMap<Object, Integer>();
    removedKeys.put(new YTRecordId("#1:13"), 1);
  ...
  public void testProcessChangeEventAddTwiceRemoveOnce() {
    ...
    final OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable> multiValueChangeEventTwo =
        new OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable>(
            OMultiValueChangeEvent.OChangeType.ADD, new YTRecordId("#1:12"),
            new YTRecordId("#1:12"));
    final OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable> multiValueChangeEventThree =
        new OMultiValueChangeEvent<YTIdentifiable, YTIdentifiable>(
            OMultiValueChangeEvent.OChangeType.REMOVE,
            new YTRecordId("#1:12"),
            null,
