    ...
    var rid =
        db.computeInTx(
            () -> {
              ...
              document.field("test1", new ArrayList<EntityImpl>(), YTType.EMBEDDEDLIST);
              document.field("test2", new ArrayList<EntityImpl>(), YTType.LINKLIST);
              document.field("test3", new HashSet<EntityImpl>(), YTType.EMBEDDEDSET);
              document.field("test4", new HashSet<EntityImpl>(), YTType.LINKSET);
              document.field("test5", new HashMap<String, EntityImpl>(), YTType.EMBEDDEDMAP);
              document.field("test6", new HashMap<String, EntityImpl>(), YTType.LINKMAP);
              db.save(document);
              return document.getIdentity();
            });
