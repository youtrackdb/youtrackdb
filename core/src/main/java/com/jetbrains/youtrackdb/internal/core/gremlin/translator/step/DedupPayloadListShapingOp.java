 ...
 * {@link BoundaryOutputType#SINGLE_VALUE} stream. MATCH {@code RETURN DISTINCT} would range over
 * {@code (entity, value)} and cannot collapse two elements that share a scalar, so this stage runs
 * after row projection on the payloads themselves.
 */
