 ...
 */
public class ConfigurableStatelessFactory<K, V> {
  ...
  public ConfigurableStatelessFactory<K, V> registerImplementation(final K iKey, final V iValue) {
    registry.put(iKey, iValue);
    return this;
  }

  public ConfigurableStatelessFactory<K, V> unregisterImplementation(final K iKey) {
    registry.remove(iKey);
    return this;
  }

  public ConfigurableStatelessFactory<K, V> unregisterAllImplementations() {
    registry.clear();
    return this;
  }
  ...
  public ConfigurableStatelessFactory<K, V> setDefaultImplementation(final V defaultImpl) {
