...
import com.jetbrains.youtrack.db.internal.core.exception.YTSchemaNotCreatedException;
...
public abstract class OSchemaShared implements OCloseable {
   ...
   * (non-Javadoc)
   *
   * @see com.orientechnologies.core.schema.metadata.YTSchema#dropClass(java.lang.String)
   */
   ...
   * (non-Javadoc)
   *
   * @see com.orientechnologies.core.schema.metadata.YTSchema#getClass(java.lang.Class)
   */
   ...
   * (non-Javadoc)
   *
   * @see com.orientechnologies.core.schema.metadata.YTSchema#getClass(java.lang.String)
   */
   ...
   */
  public void fromStream(YTDatabaseSessionInternal session, EntityImpl document) {
    lock.writeLock().lock();
    modificationCounter.increment();
    try {
   ...
   */
  public EntityImpl toStream(@Nonnull YTDatabaseSessionInternal db) {
    lock.readLock().lock();
    try {
