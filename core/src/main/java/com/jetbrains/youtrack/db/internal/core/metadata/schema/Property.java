...
public interface Property extends Comparable<Property> {
   ...
   *                </ul>
   * @return see
   * {@link SchemaClass#createIndex(DatabaseSession, String, SchemaClass.INDEX_TYPE, String...)}.
   */
  Index createIndex(DatabaseSession session, final INDEX_TYPE iType);
   ...
   * {@link SchemaClass#createIndex(DatabaseSession, String, SchemaClass.INDEX_TYPE, String...)}.
   */
  Index createIndex(DatabaseSession session, final String iType);
   ...
   * {@link SchemaClass#createIndex(DatabaseSession, String, SchemaClass.INDEX_TYPE, String...)}.
   */
  Index createIndex(DatabaseSession session, String iType, EntityImpl metadata);
   ...
   * {@link SchemaClass#createIndex(DatabaseSession, String, SchemaClass.INDEX_TYPE, String...)}.
   */
  Index createIndex(DatabaseSession session, INDEX_TYPE iType, EntityImpl metadata);
   ...
   */
  @Deprecated
  Property dropIndexes(DatabaseSessionInternal session);
   ...
   */
  @Deprecated
  Index getIndex(DatabaseSession session);

  /**
   * @return All indexes in which this property participates.
   */
  Collection<Index> getAllIndexes(DatabaseSession session);
   ...
   * {@link #getAllIndexes(DatabaseSession)} instead.
   *
   ...
   */
  @Deprecated
  boolean isIndexed(DatabaseSession session);
