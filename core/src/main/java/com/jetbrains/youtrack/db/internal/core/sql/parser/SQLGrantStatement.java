/* Generated By:JJTree: Do not edit this line. SQLGrantStatement.java Version 4.3 */
...
public class SQLGrantStatement extends SQLSimpleExecStatement {

  protected SQLPermission permission;
  protected SQLIdentifier policyName;
  protected SQLSecurityResourceSegment securityResource;
  protected SQLIdentifier actor;

  public SQLGrantStatement(int id) {
    super(id);
  }

  public SQLGrantStatement(YouTrackDBSql p, int id) {
    super(p, id);
  }
