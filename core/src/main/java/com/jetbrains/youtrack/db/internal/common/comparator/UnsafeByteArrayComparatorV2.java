...
public class UnsafeByteArrayComparatorV2 implements Comparator<byte[]> {

  public static final UnsafeByteArrayComparatorV2 INSTANCE = new UnsafeByteArrayComparatorV2();
  ...
  public int compare(byte[] arrayOne, byte[] arrayTwo) {
    ...
    for (var i = WORDS * LONG_SIZE; i < arrayOne.length; i++) {
