...
public class YTIterationException extends YTSystemException {

  private static final long serialVersionUID = 2347493191705052402L;

  public YTIterationException(YTIterationException exception) {
    super(exception);
  }

  public YTIterationException(String message) {
    super(message);
  }
}
