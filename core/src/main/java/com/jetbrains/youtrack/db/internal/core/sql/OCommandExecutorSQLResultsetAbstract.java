...
public abstract class OCommandExecutorSQLResultsetAbstract extends OCommandExecutorSQLAbstract
  ...
  protected boolean filter(final Record iRecord, final OCommandContext iContext) {
  ...
  protected boolean evaluateRecord(final Record iRecord, final OCommandContext iContext) {
