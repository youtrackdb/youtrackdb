/* Generated By:JJTree: Do not edit this line. SQLCreateSystemUserStatement.java Version 4.3 */
...
public class SQLCreateSystemUserStatement extends SQLSimpleExecServerStatement {
  ...
  public SQLCreateSystemUserStatement(int id) {
    super(id);
  }

  public SQLCreateSystemUserStatement(YouTrackDBSql p, int id) {
    super(p, id);
  }
