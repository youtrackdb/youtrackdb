...
public class BinaryProtocol {
  ...
  public static byte[] long2bytes(final long value) {
    return BinaryProtocol.long2bytes(value, new byte[8], 0);
  }
  ...
  public static byte[] int2bytes(final int value) {
    return BinaryProtocol.int2bytes(value, new byte[4], 0);
  }
  ...
  public static byte[] short2bytes(final short value) {
    return BinaryProtocol.short2bytes(value, new byte[2], 0);
  }
  ...
  public static long bytes2long(final byte[] b) {
    return BinaryProtocol.bytes2long(b, 0);
  }
