 ...
 *
 * <p>
 * <!--The 'C' character is allowed for the day-of-month and day-of-week fields. This character is short-hand for "calendar". This
 * means values are calculated against the associated calendar, if any. If no calendar is associated, then it is equivalent to
 * having an all-inclusive calendar. A value of "5C" in the day-of-month field means "the first day included by the calendar on or
...
public final class OCronExpression implements Serializable, Cloneable {
  ...
  public Date getNextInvalidTimeAfter(Date date) {
    ...
    // Performance will be very bad here,
  ...
  @Deprecated
  public Object clone() {
    return new OCronExpression(this);
  }
}
