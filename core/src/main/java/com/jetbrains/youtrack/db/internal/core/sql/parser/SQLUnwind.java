...
public class SQLUnwind extends SimpleNode {

  protected List<SQLIdentifier> items = new ArrayList<SQLIdentifier>();

  public SQLUnwind(int id) {
    super(id);
  }

  public SQLUnwind(YouTrackDBSql p, int id) {
    super(p, id);
  }
  ...
  public List<SQLIdentifier> getItems() {
    return items;
  }

  public void addItem(SQLIdentifier iter) {
    this.items.add(iter);
  }
