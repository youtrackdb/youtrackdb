...
public class ConcurrentLegacyResultSet<T> implements LegacyResultSet<T> {
  ...
  protected final transient BasicLegacyResultSet<T> wrapped;
  protected transient volatile boolean completed = false;

  public ConcurrentLegacyResultSet() {
    this.wrapped = new BasicLegacyResultSet<T>();
  }

  public ConcurrentLegacyResultSet(final BasicLegacyResultSet<T> wrapped) {
  ...
  public Iterator<T> iterator() {
    return new Iterator<T>() {
      ...
      @Override
      public void remove() {
        throw new UnsupportedOperationException("LegacyResultSet.iterator.remove()");
      }
    };
  }
