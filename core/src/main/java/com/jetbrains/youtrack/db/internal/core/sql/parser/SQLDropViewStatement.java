/* Generated By:JJTree: Do not edit this line. SQLDropViewStatement.java Version 4.3 */
...
public class SQLDropViewStatement extends ODDLStatement {
  ...
  public SQLDropViewStatement(int id) {
    super(id);
  }

  public SQLDropViewStatement(YouTrackDBSql p, int id) {
    super(p, id);
  }
  ...
  @Override
  public SQLDropViewStatement copy() {
    SQLDropViewStatement result = new SQLDropViewStatement(-1);
  ...
  public boolean equals(Object o) {
    ...
    SQLDropViewStatement that = (SQLDropViewStatement) o;
