 ...
 */
public class Krb5ClientLoginModuleConfig extends Configuration {
  ...
  /*
  	public Krb5ClientLoginModuleConfig(String ccPath)
  	{
  		if(ccPath != null)
  		{
  ...
  */
  ...
  public Krb5ClientLoginModuleConfig(String principal, String ccPath, String ktPath) {
    this(principal, true, ccPath, ktPath);
  }

  public Krb5ClientLoginModuleConfig(
