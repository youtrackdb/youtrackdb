...
public interface DatabaseSession extends AutoCloseable {
   ...
   * {@link Record#isNotBound(DatabaseSession)} method.
   * <p/>
   * <p>
   ...
   * @see Record#isNotBound(DatabaseSession)
   ...
   */
  @Nonnull
  <RET extends Record> RET load(RID recordId);
   ...
   */
  @Nullable
  default <RET extends Record> RET loadSilently(RID recordId) {
    try {
   ...
   *
   * @return An iterable of DatabaseListener instances.
   */
  Iterable<DatabaseListener> getListeners();
