...
public class StorageFileConfiguration implements Serializable {

  public transient StorageSegmentConfiguration parent;
  ...
  public StorageFileConfiguration() {
  }

  public StorageFileConfiguration(
      final StorageSegmentConfiguration iParent,
      final String iPath,
      final String iType,
