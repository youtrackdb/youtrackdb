...
public interface YTDatabaseSession extends AutoCloseable {
   ...
   * {@link Record#isNotBound(YTDatabaseSession)} method.
   * <p/>
   * <p>
   ...
   * @see Record#isNotBound(YTDatabaseSession)
   ...
   */
  @Nonnull
  default Entity loadEntity(YTRID id) throws YTDatabaseException, YTRecordNotFoundException {
    var record = load(id);
   ...
   */
  @Nonnull
  default Vertex loadVertex(YTRID id) throws YTDatabaseException, YTRecordNotFoundException {
    var record = load(id);
   ...
   */
  @Nonnull
  default Edge loadEdge(YTRID id) throws YTDatabaseException, YTRecordNotFoundException {
    var record = load(id);
   ...
   */
  @Nonnull
  default Blob loadBlob(YTRID id) throws YTDatabaseException, YTRecordNotFoundException {
    var record = load(id);
   ...
   * @return the edge
   */
  default Edge newEdge(Vertex from, Vertex to) {
   ...
   * @return the edge
   */
  Edge newEdge(Vertex from, Vertex to, YTClass type);
   ...
   * @return the edge
   */
  EdgeInternal newEdge(Vertex from, Vertex to, String type);
  ...
  default YTClass createEdgeClass(String className) {
    ...
    edgeClass.createProperty(this, Edge.DIRECTION_IN, YTType.LINK);
    edgeClass.createProperty(this, Edge.DIRECTION_OUT, YTType.LINK);
   ...
   */
  @Nonnull
  <RET extends Record> RET load(YTRID recordId);
   ...
   */
  @Nullable
  default <RET extends Record> RET loadSilently(YTRID recordId) {
    try {
