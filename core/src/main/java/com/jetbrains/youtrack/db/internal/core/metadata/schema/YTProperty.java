...
public interface YTProperty extends Comparable<YTProperty> {
   ...
   * YTClass.INDEX_TYPE, String...)}.
   */
  OIndex createIndex(YTDatabaseSession session, String iType, EntityImpl metadata);
   ...
   * YTClass.INDEX_TYPE, String...)}.
   */
  OIndex createIndex(YTDatabaseSession session, INDEX_TYPE iType, EntityImpl metadata);
