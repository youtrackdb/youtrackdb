...
import com.jetbrains.youtrack.db.internal.core.schedule.OScheduler.STATUS;
...
public class OScheduledEvent extends ODocumentWrapper {
   ...
   */
  public OScheduledEvent(final EntityImpl doc, YTDatabaseSession session) {
    super(doc);
    ...
    if (function == null) {
      ...
      if (funcDoc != null) {
        if (funcDoc instanceof OFunction) {
          ...
          function = new OFunction((EntityImpl) funcDoc);
