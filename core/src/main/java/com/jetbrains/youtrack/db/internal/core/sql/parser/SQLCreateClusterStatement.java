/* Generated By:JJTree: Do not edit this line. SQLCreateClusterStatement.java Version 4.3 */
...
public class SQLCreateClusterStatement extends ODDLStatement {
  ...
  public SQLCreateClusterStatement(int id) {
    super(id);
  }

  public SQLCreateClusterStatement(YouTrackDBSql p, int id) {
    super(p, id);
  }
