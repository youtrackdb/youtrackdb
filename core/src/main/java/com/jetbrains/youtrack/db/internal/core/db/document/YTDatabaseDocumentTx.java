...
import static com.jetbrains.youtrack.db.internal.core.db.document.ODatabaseDocumentTxInternal.closeAllOnShutdown;
...
public class YTDatabaseDocumentTx implements YTDatabaseSessionInternal {
  ...
  @Nonnull
  @Override
  public <RET extends RecordAbstract> RET executeReadRecord(YTRecordId rid) {
    checkOpenness();
  ...
  @Nonnull
  @Override
  public <RET extends Record> RET load(YTRID recordId) {
    checkOpenness();
  ...
  @Override
  public YTDatabaseSession create(Map<GlobalConfiguration, Object> iInitialSettings) {
    setupThreadOwner();
    try {
