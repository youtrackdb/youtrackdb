...
import com.jetbrains.youtrack.db.internal.common.thread.OThreadPoolExecutorWithLogging;
...
public abstract class YTSequence {
  ...
  protected YTSequence(EntityImpl document) {
  ...
  private void initSequence(EntityImpl document, YTSequence.CreateParams params) {
  ...
  public interface SequenceCallable {
    ...
    long call(YTDatabaseSession db, EntityImpl doc);
  }
}
