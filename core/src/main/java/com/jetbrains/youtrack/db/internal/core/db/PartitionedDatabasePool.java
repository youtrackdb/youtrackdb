...
public class PartitionedDatabasePool extends YouTrackDBListenerAbstract {
  ...
  public PartitionedDatabasePool(String url, String userName, String password) {
    this(url, userName, password, Runtime.getRuntime().availableProcessors(), -1);
  }

  public PartitionedDatabasePool(
  ...
  public PartitionedDatabasePool setAutoCreate(final boolean autoCreate) {
