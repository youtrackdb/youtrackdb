...
public class YTValidationException extends YTCoreException implements YTHighLevelException {

  public YTValidationException(YTValidationException exception) {
    super(exception, OErrorCode.VALIDATION_ERROR);
  }

  public YTValidationException(String string) {
