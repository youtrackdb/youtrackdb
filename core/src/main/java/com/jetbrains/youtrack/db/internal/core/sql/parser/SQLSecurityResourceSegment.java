/* Generated By:JJTree: Do not edit this line. SQLSecurityResourceSegment.java Version 4.3 */
/* JavaCCOptions:MULTI=true,NODE_USES_PARSER=false,VISITOR=true,TRACK_TOKENS=true,NODE_PREFIX=O,NODE_EXTENDS=,NODE_FACTORY=,SUPPORT_CLASS_VISIBILITY_PUBLIC=true */
package com.jetbrains.youtrack.db.internal.core.sql.parser;

import java.util.Map;

public class SQLSecurityResourceSegment extends SimpleNode {

  protected boolean star = false;
  protected SQLIdentifier identifier;

  protected SQLSecurityResourceSegment next;

  public SQLSecurityResourceSegment(int id) {
    super(id);
  }

  public SQLSecurityResourceSegment(YouTrackDBSql p, int id) {
    super(p, id);
  }
  ...
  public SQLSecurityResourceSegment getNext() {
    return next;
  }
