...
package com.jetbrains.youtrack.db.internal.core.storage.cluster.v0;

import com.jetbrains.youtrack.db.internal.common.util.OCommonConst;
import com.jetbrains.youtrack.db.internal.core.exception.YTClusterPositionMapException;
 ...
 * @since 10/7/13
 */
public class ClusterPositionMapV0 extends ClusterPositionMap {

  private long fileId;

  ClusterPositionMapV0(
      final AbstractPaginatedStorage storage, final String name, final String lockName) {
