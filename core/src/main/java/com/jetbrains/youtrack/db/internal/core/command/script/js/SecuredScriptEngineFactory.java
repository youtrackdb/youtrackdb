...
import com.jetbrains.youtrack.db.internal.core.command.script.SecuredScriptFactory;
import java.util.List;
import javax.script.ScriptEngine;
import javax.script.ScriptEngineFactory;

public class SecuredScriptEngineFactory extends SecuredScriptFactory {

  private final ScriptEngineFactory engineFactory;

  public SecuredScriptEngineFactory(ScriptEngineFactory engineFactory) {
