 ...
 */
public class YTDistributedRedirectException extends YTSystemException {

  private final String fromServer;
  private final String toServer;
  private final String toServerAddress;

  public YTDistributedRedirectException(final YTDistributedRedirectException exception) {
    super(exception);
  ...
  public YTDistributedRedirectException(
