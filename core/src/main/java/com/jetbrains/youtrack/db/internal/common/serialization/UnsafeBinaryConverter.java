...
public class UnsafeBinaryConverter implements BinaryConverter {

  public static final UnsafeBinaryConverter INSTANCE = new UnsafeBinaryConverter();

  private static final Unsafe theUnsafe;
  private static final long BYTE_ARRAY_OFFSET;

  private static final boolean useOnlyAlignedAccess =
      GlobalConfiguration.DIRECT_MEMORY_ONLY_ALIGNED_ACCESS.getValueAsBoolean();
