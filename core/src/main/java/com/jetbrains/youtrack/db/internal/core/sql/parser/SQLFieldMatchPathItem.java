/* Generated By:JJTree: Do not edit this line. SQLFieldMatchPathItem.java Version 4.3 */
...
public class SQLFieldMatchPathItem extends SQLMatchPathItem {

  protected SQLIdentifier field;

  private SQLSuffixIdentifier exp;

  public SQLFieldMatchPathItem(int id) {
    super(id);
  }

  public SQLFieldMatchPathItem(YouTrackDBSql p, int id) {
    super(p, id);
  }
  ...
  public SQLMatchPathItem copy() {
    SQLFieldMatchPathItem result = null;
    try {
  ...
  public SQLIdentifier getField() {
    return field;
  }

  public SQLSuffixIdentifier getExp() {
    if (exp == null) {
      exp = new SQLSuffixIdentifier(field);
    }
    return exp;
