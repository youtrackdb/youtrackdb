 ...
 * No encryption.
 */
public class NothingEncryption implements Encryption {

  public static final String NAME = "nothing";

  public static final NothingEncryption INSTANCE = new NothingEncryption();
  ...
  @Override
  public Encryption configure(String iOptions) {
    return null;
  }
}
