...
import com.jetbrains.youtrack.db.internal.core.db.record.OIdentifiableMultiValue;
...
public class ODocumentFieldWalker {
  ...
  public EntityImpl walkDocument(
      YTDatabaseSessionInternal session, EntityImpl document, ODocumentFieldVisitor fieldWalker) {
      ...
      if (!updated
        ...
        if (fieldWalker.goDeeper(fieldType, linkedType, fieldValue)) {
          if (fieldValue instanceof Map) {
            ...
            walkIterable(
                session,
                OMultiValue.getMultiValueIterable(
                    fieldValue),
                fieldType,
                fieldWalker,
                walked);
