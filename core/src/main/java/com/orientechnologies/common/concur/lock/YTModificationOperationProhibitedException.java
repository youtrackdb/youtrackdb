 ...
 * @since 03.07.12
 */
public class YTModificationOperationProhibitedException extends YTCoreException
    implements YTHighLevelException {

  private static final long serialVersionUID = 1L;

  public YTModificationOperationProhibitedException(
      YTModificationOperationProhibitedException exception) {
    super(exception);
  }

  public YTModificationOperationProhibitedException(String message) {
    super(message);
  }
}
