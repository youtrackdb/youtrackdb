 ...
 */
package com.orientechnologies.core.sql.method;

import com.orientechnologies.common.exception.YTException;
import com.orientechnologies.core.exception.YTCommandExecutionException;
import com.orientechnologies.core.sql.functions.coll.OSQLMethodMultiValue;
import com.orientechnologies.core.sql.functions.conversion.OSQLMethodAsDate;
import com.orientechnologies.core.sql.functions.conversion.OSQLMethodAsDateTime;
import com.orientechnologies.core.sql.functions.conversion.OSQLMethodAsDecimal;
import com.orientechnologies.core.sql.functions.conversion.OSQLMethodBeforeUpdate;
import com.orientechnologies.core.sql.functions.conversion.OSQLMethodConvert;
import com.orientechnologies.core.sql.functions.misc.OSQLMethodExclude;
import com.orientechnologies.core.sql.functions.misc.OSQLMethodInclude;
import com.orientechnologies.core.sql.functions.text.OSQLMethodAppend;
import com.orientechnologies.core.sql.functions.text.OSQLMethodFromJSON;
import com.orientechnologies.core.sql.functions.text.OSQLMethodHash;
import com.orientechnologies.core.sql.functions.text.OSQLMethodLength;
import com.orientechnologies.core.sql.functions.text.OSQLMethodReplace;
import com.orientechnologies.core.sql.functions.text.OSQLMethodRight;
import com.orientechnologies.core.sql.functions.text.OSQLMethodSubString;
import com.orientechnologies.core.sql.functions.text.OSQLMethodToJSON;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsBoolean;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsFloat;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsInteger;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsList;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsLong;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsMap;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsSet;
import com.orientechnologies.core.sql.method.misc.OSQLMethodAsString;
import com.orientechnologies.core.sql.method.misc.OSQLMethodField;
import com.orientechnologies.core.sql.method.misc.OSQLMethodFormat;
import com.orientechnologies.core.sql.method.misc.OSQLMethodFunctionDelegate;
import com.orientechnologies.core.sql.method.misc.OSQLMethodIndexOf;
import com.orientechnologies.core.sql.method.misc.OSQLMethodJavaType;
import com.orientechnologies.core.sql.method.misc.OSQLMethodKeys;
import com.orientechnologies.core.sql.method.misc.OSQLMethodLastIndexOf;
import com.orientechnologies.core.sql.method.misc.OSQLMethodNormalize;
import com.orientechnologies.core.sql.method.misc.OSQLMethodPrefix;
import com.orientechnologies.core.sql.method.misc.OSQLMethodRemove;
import com.orientechnologies.core.sql.method.misc.OSQLMethodRemoveAll;
import com.orientechnologies.core.sql.method.misc.OSQLMethodSize;
import com.orientechnologies.core.sql.method.misc.OSQLMethodSplit;
import com.orientechnologies.core.sql.method.misc.OSQLMethodToLowerCase;
import com.orientechnologies.core.sql.method.misc.OSQLMethodToUpperCase;
import com.orientechnologies.core.sql.method.misc.OSQLMethodTrim;
import com.orientechnologies.core.sql.method.misc.OSQLMethodType;
import com.orientechnologies.core.sql.method.misc.OSQLMethodValues;
import com.orientechnologies.core.sql.method.sequence.OSQLMethodCurrent;
import com.orientechnologies.core.sql.method.sequence.OSQLMethodNext;
import com.orientechnologies.core.sql.method.sequence.OSQLMethodReset;
