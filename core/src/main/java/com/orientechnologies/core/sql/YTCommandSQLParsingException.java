...
import com.orientechnologies.core.sql.parser.TokenMgrError;

public class YTCommandSQLParsingException extends YTCoreException {
  ...
  public YTCommandSQLParsingException(ParseException e, String statement) {
    super(
  ...
  public YTCommandSQLParsingException(TokenMgrError e, String statement) {
  ...
  public YTCommandSQLParsingException(YTCommandSQLParsingException exception) {
    super(exception);
  ...
  public YTCommandSQLParsingException(String iMessage) {
    super(iMessage);
  }

  public YTCommandSQLParsingException(String iMessage, String iText, int iPosition) {
