...
import com.orientechnologies.core.sql.OCommandExecutorSQLSelect;
...
public class OSQLPredicate extends OBaseParser implements OCommandPredicate {
  ...
  public OSQLPredicate(@Nonnull OCommandContext context) {
    this.context = context;
  }

  public OSQLPredicate(@Nonnull OCommandContext context, final String iText) {
    this.context = context;
