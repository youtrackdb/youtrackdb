 ...
 * properties.
 */
public enum YTGlobalConfiguration {
  ...
  CACHE_LOCAL_IMPL(
      ...
      String.class,
      "com.orientechnologies.core.cache.ORecordCacheWeakRefs"),
  ...
  public static void dumpConfiguration(final PrintStream out) {
    ...
    String lastSection = "";
    for (YTGlobalConfiguration value : values()) {
  ...
  /**
   * Find the YTGlobalConfiguration instance by the key. Key is case insensitive.
   *
   * @param iKey Key to find. It's case insensitive.
   * @return YTGlobalConfiguration instance if found, otherwise null
   */
  public static YTGlobalConfiguration findByKey(final String iKey) {
    for (YTGlobalConfiguration v : values()) {
  ...
  private static void readConfiguration() {
    String prop;
    for (YTGlobalConfiguration config : values()) {
  ...
  public static String getEnvKey(YTGlobalConfiguration config) {
