 ...
 */
package com.orientechnologies.core.metadata.schema.clusterselection;
...
public class OBalancedClusterSelectionStrategy implements OClusterSelectionStrategy {
  ...
  public int getCluster(final YTClass iClass, final int[] clusters, final YTEntityImpl doc) {
