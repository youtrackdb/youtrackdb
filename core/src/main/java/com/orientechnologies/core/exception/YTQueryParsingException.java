...
public class YTQueryParsingException extends YTCommandSQLParsingException {
  ...
  public YTQueryParsingException(YTQueryParsingException exception) {
    super(exception);
  ...
  public YTQueryParsingException(final String iMessage) {
    super(iMessage);
  }

  public YTQueryParsingException(final String iMessage, final String iText, final int iPosition) {
