...
import static com.orientechnologies.core.serialization.serializer.binary.impl.OLinkSerializer.RID_SIZE;
...
public class OStreamSerializerSBTreeIndexRIDContainer
  ...
  @Override
  public OIndexRIDContainer deserializeFromByteBufferObject(int offset, ByteBuffer buffer) {
