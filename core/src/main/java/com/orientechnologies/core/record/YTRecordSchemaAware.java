 ...
 */
public interface YTRecordSchemaAware extends YTEntity {
   ...
   * in chain.
   */
  YTRecordSchemaAware field(String iFieldName, Object iFieldValue);
   ...
   *                    {@link YTType} enum
   */
  YTRecordSchemaAware field(String iFieldName, Object iFieldValue, YTType... iType);
