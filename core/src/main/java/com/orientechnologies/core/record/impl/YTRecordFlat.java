...
@Deprecated
public class YTRecordFlat extends YTRecordAbstract implements ORecordStringable {

  private static final long serialVersionUID = 1L;
  public static final byte RECORD_TYPE = 'f';
  protected String value;

  public YTRecordFlat(YTDatabaseSessionInternal iDatabase) {
    this();
    ODatabaseRecordThreadLocal.instance().set(iDatabase);
  }

  public YTRecordFlat(YTRID rid) {
  ...
  public YTRecordFlat value(final String iValue) {
    value = iValue;
    setDirty();
    return this;
  }
  ...
  public YTRecordFlat copy() {
    YTRecordFlat cloned = new YTRecordFlat();
