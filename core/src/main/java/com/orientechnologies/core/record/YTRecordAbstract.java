...
import com.orientechnologies.core.id.ChangeableIdentity;
import com.orientechnologies.core.id.ChangeableRecordId;
import com.orientechnologies.core.id.IdentityChangeListener;
...
public abstract class YTRecordAbstract implements YTRecord, RecordElement, OSerializableStream,
  ...
  public YTRecordAbstract() {
  }

  public YTRecordAbstract(final byte[] iSource) {
    source = iSource;
    size = iSource.length;
    unsetDirty();
  }
  ...
  public final YTRecordAbstract setIdentity(final YTRecordId iIdentity) {
    recordId = iIdentity;
    return this;
  }
  ...
  @Nonnull
  public YTRecordAbstract getRecord() {
    return this;
  }
  ...
  public <RET extends YTRecord> RET fromJSON(final String iSource, final String iOptions) {
  ...
  public final <RET extends YTRecord> RET fromJSON(final String iSource, boolean needReload) {
    status = STATUS.UNMARSHALLING;
    try {
  ...
  public final <RET extends YTRecord> RET fromJSON(final InputStream iContentResult)
      throws IOException {
    status = STATUS.UNMARSHALLING;
    try {
  ...
  public YTRecordAbstract copyTo(final YTRecordAbstract cloned) {
    checkForBinding();
  ...
  protected final YTRecordAbstract setIdentity(final int iClusterId, final long iClusterPosition) {
  ...
  public abstract YTRecordAbstract copy();
