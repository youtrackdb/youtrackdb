...
/**
 * YTVertex interface represents a vertex in a graph database. Unlike non-typed record it treats some
 ...
 */
public interface YTVertex extends YTEntity {
   ...
   */
  Iterable<YTEdge> getEdges(ODirection direction);
   ...
   * @return an iterable collection of edges connected to the vertex
   */
  Iterable<YTEdge> getEdges(ODirection direction, String... label);
   ...
   * @return an iterable collection of edges connected to the vertex
   */
  Iterable<YTEdge> getEdges(ODirection direction, YTClass... label);
   ...
   */
  Iterable<YTVertex> getVertices(ODirection direction);
   ...
   * @return an iterable collection of vertices connected to the current vertex
   */
  Iterable<YTVertex> getVertices(ODirection direction, String... label);
   ...
   * @return an iterable collection of vertices connected to the current vertex
   */
  Iterable<YTVertex> getVertices(ODirection direction, YTClass... label);
   ...
   * @return the created edge
   */
  YTEdge addLightWeightEdge(YTVertex to);
   ...
   * @return the created edge
   */
  YTEdge addEdge(YTVertex to, String label);
   ...
   * @return the created edge
   */
  YTEdge addLightWeightEdge(YTVertex to, String label);
   ...
   * @return the created edge
   */
  YTEdge addEdge(YTVertex to, YTClass label);
   ...
   * @return the created edge
   */
  YTEdge addLightWeightEdge(YTVertex to, YTClass label);
