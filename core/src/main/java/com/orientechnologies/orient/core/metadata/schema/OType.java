...
public enum OType {
  ...
  private static final Map<Class<?>, OType> TYPES_BY_CLASS = new HashMap<>();
  ...
  private final Set<OType> castable;
        ...
        if (OMultiValue.isMultiValue(value)) {
          ...
          for (Object o : OMultiValue.getMultiValueIterable(value)) {
            if (o instanceof OIdentifiable) {
              ...
              try {
                result.add(new ORecordId(value.toString()));
              } catch (Exception e) {
      ...
      if (targetClass.equals(ORidBag.class) && value instanceof Iterable<?> iterable) {
        ...
        for (var item : iterable) {
          if (item instanceof OIdentifiable identifiable) {
            ...
            ridBag.add(new ORecordId((String) item));
          }
        }
