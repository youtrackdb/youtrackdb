...
public class ORecordNotFoundException extends OCoreException implements OHighLevelException {
  ...
  public ORecordNotFoundException(final YTRID iRID) {
    super("The record with id '" + iRID + "' was not found");
    rid = iRID;
  }

  public ORecordNotFoundException(final YTRID iRID, final String message) {
    super(message);
    rid = iRID;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    return rid != null && rid.equals(((ORecordNotFoundException) obj).rid);
  }
