...
public class OImmutableProperty implements OProperty {
  ...
  public OImmutableProperty(ODatabaseSessionInternal session, OProperty property,
  ...
  private <T> T safeConvert(ODatabaseSessionInternal session, Object value, Class<T> target,
      String type) {
    T mc;
    try {
      mc = (T) OType.convert(session, value, target);
  ...
  @Override
  public OProperty setName(ODatabaseSession session, String iName) {
  ...
  @Override
  public void set(ODatabaseSession session, ATTRIBUTES attribute, Object iValue) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setNotNull(ODatabaseSession session, boolean iNotNull) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setCollate(ODatabaseSession session, String iCollateName) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setMandatory(ODatabaseSession session, boolean mandatory) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setReadonly(ODatabaseSession session, boolean iReadonly) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setMin(ODatabaseSession session, String min) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setMax(ODatabaseSession session, String max) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setDefaultValue(ODatabaseSession session, String defaultValue) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setRegexp(ODatabaseSession session, String regexp) {
    throw new UnsupportedOperationException();
  }

  @Override
  public OProperty setType(ODatabaseSession session, OType iType) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public OProperty setCustom(ODatabaseSession session, String iName, String iValue) {
    throw new UnsupportedOperationException();
  }
